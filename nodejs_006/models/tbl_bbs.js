module.exports = (sequelize, DataTypes) => {
  const bbs = sequelize.define("tbl_bbs", {
    b_id: { type: DataTypes.INTEGER, autoIncrement: true, primaryKey: true },
  ...
  // bbs(tbl_bbs table)과 tbl_replay 를 1 : N 관계로 설정
  // 이때 tbl_bbs.b_id 칼럼과 tbl_replay.r_postId 칼럼을 연관지어 FK 설정
